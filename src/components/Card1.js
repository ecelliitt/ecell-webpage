...
const Card1 = (props) => {
    ...
    return (
        ...
        <div className={"card1-container sm:mx-auto my-[3%]  md:mx-10 w-fit"} id={"key-"+props.key_prop}>
            <figure className="snip1344 w-[250px] h-[250px]"><img src={props.members.Photo} alt="profile-sample1" className="background" /><img src={props.members.Photo} alt="profile-sample1" className="profile mt-10 w-130px max-h-90px md:w-[150px] md:max-h-[130px]" />
                <figcaption>
                    <h3 style={{fontSize:'large'}}>{props.members.Name}<span>{props.members.Position}</span></h3>
